...
public class TCPSocketServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Crie uma instancia da class SocketServer, especializada para servidores
            // (listen embutido)
            ...
            while (true) {
                ...
                BufferedReader doClienteBF = new BufferedReader(
                        new InputStreamReader(socketConectado.getInputStream()));
